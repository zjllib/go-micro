# Plugins [![License](https://img.shields.io/:license-apache-blue.svg)](https://opensource.org/licenses/Apache-2.0) [![GoDoc](https://godoc.org/github.com/zjllib/go-micro/plugins?status.svg)](https://godoc.org/github.com/zjllib/go-micro/plugins)
